...
export const metadata: Metadata = {
  title: "Premium Properties | Luxury Real Estate Investment",  description: "Discover handpicked luxury properties in prime locations. Verified listings, transparent pricing, and expert guidance for smart real estate investments. 1,500+ successful transactions.",  keywords: "luxury real estate, property investment, premium homes, verified listings, real estate agent",  metadataBase: new URL("https://img.b2bpic.net/free-photo/attractive-woman-reading-magazine-near-panoramic-window_7502-9287.jpg"),
  alternates: {
    canonical: "https://img.b2bpic.net/free-photo/attractive-woman-reading-magazine-near-panoramic-window_7502-9287.jpg"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    type: "website",    title: "Premium Properties | Luxury Real Estate Investment",    description: "Discover handpicked luxury properties in prime locations. Verified listings, transparent pricing, and expert guidance for smart real estate investments.",    siteName: "Premier Properties",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/attractive-woman-reading-magazine-near-panoramic-window_7502-9287.jpg",        alt: "Luxury penthouse with city views"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Premium Properties | Luxury Real Estate Investment",    description: "Discover handpicked luxury properties. Verified listings, transparent pricing, expert guidance.",    images: ["https://img.b2bpic.net/free-photo/attractive-woman-reading-magazine-near-panoramic-window_7502-9287.jpg"]
  }
};
