    ...
    return (
        <div className={cls("relative h-full min-h-0 flex flex-col gap-4", cardClassName)}>
            ...
            <div className="flex flex-col gap-1">
                <h3 className={cls("relative z-1 text-lg font-medium leading-tight", (useInvertedBackground === "invertDefault" || useInvertedBackground === "invertCard") ? "text-background" : "text-foreground", featureTitleClassName)}>
                    {feature.title}
                </h3>
                <p className={cls("relative z-1 text-base leading-tight truncate", (useInvertedBackground === "invertDefault" || useInvertedBackground === "invertCard") ? "text-background/75" : "text-foreground/75", featureDescriptionClassName)}>
                    {feature.description}
                </p>
            </div>
        </div>
