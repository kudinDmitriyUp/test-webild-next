    ...
    const textContent = (
        <div className={cls("w-full md:w-2/5 flex flex-col gap-3", textContainerClassName)}>
            <TextAnimation
                ...
                text={sideTitle}
                variant="trigger"
                className={cls("text-6xl font-medium", (useInvertedBackground === "invertDefault" || useInvertedBackground === "invertCard") && "text-background", sideTitleClassName)}
            />
            {sideDescription && (
                <TextAnimation
                    type={theme.defaultTextAnimation as AnimationType}
                    ...
                    className={cls("text-lg leading-[1.2]", (useInvertedBackground === "invertDefault" || useInvertedBackground === "invertCard") && "text-background", sideDescriptionClassName)}
                />
            )}
