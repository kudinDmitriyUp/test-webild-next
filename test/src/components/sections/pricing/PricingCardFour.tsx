...
const PricingCardFour = ({
  ...
  const handleCta0Click = useButtonClick(ctaCards[0].href, ctaCards[0].onClick);
  const handleCta1Click = useButtonClick(ctaCards[1].href, ctaCards[1].onClick);
  const ctaClickHandlers = [handleCta0Click, handleCta1Click];
          ...
          >
            ...
            <div className="flex flex-col gap-4">
              {ctaCards.map((ctaCard, index) => (
                <button
                  key={index}
                  onClick={ctaClickHandlers[index]}
                  className={cls(
